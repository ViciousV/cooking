class CoworkersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @coworker.save
        format.html { redirect_to @coworker, notice: 'MEGA, you have registered yourself successfully.' }
  ...
  def update
    respond_to do |format|
      if @coworker.update(coworker_params)
        format.html { redirect_to @coworker, notice: 'MEGA, you have changed your Details successfully' }
  ...
  def destroy
    @coworker.destroy
    respond_to do |format|
      format.html { redirect_to coworkers_url, notice: 'Nobody knows why, but you have deleted yourself successfully.' }
  ...
  private
    ...
    def coworker_params
      params.require(:coworker).permit(:email, :name)
    end
end
